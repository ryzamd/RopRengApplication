...
export interface PreOrderProductItemEditRef {
  present: (item: CartItem) => void;
  dismiss: () => void;
}

export const PreOrderProductItemEditBottomSheet = forwardRef<PreOrderProductItemEditRef>((props, ref) => {
...
PreOrderProductItemEditBottomSheet.displayName = 'PreOrderProductItemEditBottomSheet';
