...
import { Topping } from '../../order/OrderInterfaces';
import { TOPPING_TEXT } from '../PreOrderConstants';
        ...
        {MOCK_TOPPINGS.map((topping) => {
          ...
          return (
            ...
            >
              ...
              <Text style={styles.toppingPrice}>{PreOrderService.formatPrice(topping.price)}</Text>
            </TouchableOpacity>
          );
        })}
